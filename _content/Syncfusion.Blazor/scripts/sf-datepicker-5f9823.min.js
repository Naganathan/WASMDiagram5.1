...
window.sfBlazor.DatePicker = function () {
  ...
  function () {
    ...
    SfDatePicker.prototype.documentHandler = function (e) {
      ...
      if (!sf.base.closest(target, '.' + ROOT + '.' + POPUP_CONTAINER) && !sf.base.closest(target, '.' + 'e-datetimepicker' + '.' + POPUP_CONTAINER) && !(sf.base.closest(target, '.' + INPUTCONTAINER) === this.containerElement) && !target.classList.contains(DAY)) {
        this.dotNetRef.invokeMethodAsync(HIDE_POPUP, e);
        this.element.focus();
