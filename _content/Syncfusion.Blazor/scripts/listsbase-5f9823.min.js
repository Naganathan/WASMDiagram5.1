  ...
  (function (ListBase) {
    ...
    headerItems, options, componentInstance) {
      ...
      for (var _i = 0, headerItems_1 = headerItems; _i < headerItems_1.length; _i++) {
        ...
        header.innerHTML = ''; // tslint:disable-next-line
    ...
    function processSubChild(createElement, fieldData, fields, ds, // tslint:disable-next-line
    ...
    fields, className, options, componentInstance) {
      ...
      if (grpLI && options && options.groupTemplate) {
        var compiledString = sf.base.compile(options.groupTemplate); // tslint:disable-next-line
        ...
        var compiledString = sf.base.compile(options.template); // tslint:disable-next-line
