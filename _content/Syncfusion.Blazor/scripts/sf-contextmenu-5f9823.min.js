...
window.sfBlazor.ContextMenu = function () {
  ...
  function () {
    ...
    SfContextMenu.prototype.mouseOverHandler = function (e) {
      ...
      var target = e.target;
      var menuLength = sf.base.selectAll(DOT + MENU, this.element).length;
      var scrollNav = sf.base.closest(target, SCROLLNAV);

      if (this.subMenuOpen && (menuLength > 1 || !sf.base.isNullOrUndefined(this.menuId) && !scrollNav)) {
        if (!sf.base.closest(target, HASH + this.element.id) && (sf.base.isNullOrUndefined(this.menuId) || !sf.base.closest(target, this.menuId)) || scrollNav) {
          this.dotnetRef.invokeMethodAsync(CLOSE, sf.base.isNullOrUndefined(this.menuId) || scrollNav ? 1 : 0, false, true, false);
      ...
      if (!sf.base.closest(activeEle, "" + HASH + this.element.id) && menuLength) {
        if (this.openAsMenu) {
