...
var sftoolbar = function sftoolbar(exports) {
  ...
  function (_super) {
    ...
    Toolbar.prototype.itemsRerender = function (newProp) {
      ...
      this.destroyItems();
      this.items = newProp;
      this.tbarItemsCol = this.items; // tslint:disable-next-line:no-any
          ...
          case 'items':
            if (!(newProp.items instanceof Array && oldProp.items instanceof Array) && !this.isServerRendered) {
              ...
              for (var i = 0; i < changedProb.length; i++) {
                ...
                var itemCol = [].slice.call(sf.base.selectAll('.' + CLS_ITEMS + ' .' + CLS_ITEM, tEle)); // tslint:disable-next-line:no-any
