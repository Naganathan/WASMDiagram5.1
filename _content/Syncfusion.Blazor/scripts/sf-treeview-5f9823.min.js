...
window.sfBlazor.TreeView = function () {
  ...
  function () {
    ...
    SfTreeView.prototype.initializeDrag = function () {
      ...
      this.dragObj = new sf.base.Draggable(this.element, {
        ...
        helper: function helper(e) {
          ...
          if (!_this.dragTarget || !e.element.isSameNode(dragRoot) || !dragWrap || _this.dragTarget.classList.contains(ROOT) || _this.dragTarget.classList.contains(PARENTITEM) || _this.dragTarget.classList.contains(LISTITEM) || _this.dragLi.classList.contains(DISABLE)) {
            return false;
          }
    ...
    SfTreeView.prototype.wireExpandOnEvent = function (toBind) {
      ...
      if (toBind) {
        ...
        this.touchExpandObj = new sf.base.Touch(this.element, {
          tap: function tap(e) {
            if ((_this.options.expandOnType === CLICK || _this.options.expandOnType === DBLCLICK && e.tapCount === 2) && e.originalEvent.which !== 3) {
    ...
    SfTreeView.prototype.KeyActionHandler = function (e) {
      this.updateList();
      var focusedNode = this.getFocusedNode();
  ...
  var TreeView = {
    ...
    KeyActionHandler: function KeyActionHandler(element, args) {
      if (this.valid(element)) {
        element.blazor__instance.KeyActionHandler(args);
      }
    },
